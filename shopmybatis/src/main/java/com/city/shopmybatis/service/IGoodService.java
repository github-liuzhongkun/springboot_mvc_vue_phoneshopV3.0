...
public interface IGoodService {
    ...
    //为商品增加区域，单个区域
    public int addArea(@Param("id") int id, @Param("AreaId") int AreaId) throws Exception;

    //为员商品增加区域，多个区域
    public int addAreas(@Param("id") int id, @Param("AreaIds") int[] AreaIds) throws Exception;
